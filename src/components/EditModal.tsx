      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 px-5 py-4 border-b flex-shrink-0" style={{ borderColor: "var(--border)" }}>
            <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(230,57,70,0.1)" }}>
              <PenLine size={13} style={{ color: "#E63946" }} />
            </div>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="flex flex-col md:flex-row h-full">
              ...
              {/* Desktop preview */}
              <div className="hidden md:flex w-48 flex-shrink-0 flex-col gap-3 p-4 border-l" style={{ background: "var(--bg-sidebar)", borderColor: "var(--border)" }}>
                <p className="text-[9px] font-bold uppercase tracking-widest" style={{ color: "var(--text-muted)" }}>Card Preview</p>
                <div className="rounded-xl overflow-hidden border" style={{ border: "1px solid var(--border)" }}>
                  <CardPreview title={title} previewSrc={previewSrc} price={previewPrice} mrp={previewMrp} deal={deal} accent={accent} zoom={zoom} />
                </div>
                <p className="text-[9px]" style={{ color: "var(--text-dim)" }}>Zoom slider changes image fill.</p>
              </div>
            </div>
          </div>
